        ...
        <div class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php }?>
                    <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-bandcamp"></i><span class="hide-menu">Products</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <?php }?>
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi-ticket-account mdi"></i><span class="hide-menu">Sales</span></a>
                            <ul aria-expanded="false" class="collapse">
                           
                                <li><a href="add-order.php">New Sales</a></li>
